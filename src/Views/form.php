<div class="container">
    ...
    <form action="<?= BASE_URL ?>/form" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="agence_depart_id" id="agence_depart_id">
                ...
                <?php foreach ($agences as $agence) : ?>
                    <option value="<?php echo $agence['id'] ?>"><?php echo $agence['ville'] ?></option>
                <?php endforeach ?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" class="form-control" name="date_depart" id="date_depart">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" class="form-control" name="date_arrivee" id="date_arrivee">
        </div>
    
        <!-- Nombre total de places -->
        <div class="mb-3">
            <label for="nb_total_places" class="form-label">Nombre total de places</label>
            <input type="number" class="form-control" name="nb_total_places" id="nb_total_places" min="2" max="8">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="nb_total_places_dispo" id="nb_total_places_dispo" min="1" max="7">
        </div>
    
        <!-- Bouton de validation -->
        <div class="container-fluid d-flex justify-content-center">
            <button type="submit" class="btn btn-secondary">Créer le trajet</button>
        </div>
    </form>
</div>